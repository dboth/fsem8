...
class Chooser():
    ...
    def calcVerbPair(self, verb_a, verb_b, relation):
        ...
        for sense_pair in assoc:
            ...
            rel_value = 0
            all_values.update({sense_pair: -0.37 + assoc[sense_pair] * 3.76 + lesk * 0.14 + rel_value})
...
if __name__ == "__main__":
    ...
    a.writeIntoFile("original_data/train_48_noneless.txt", "train_data_calculated_3.json")
